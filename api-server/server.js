...
6. Provide ACCURATE values for the essential nutrients listed above
  ...
  try {
    ...
    try {
      ...
      const processedImage = image;
                                         ...
                                         // SIMPLIFIED prompt - focus on essential nutrients to avoid JSON parsing errors
         const systemPrompt = `You are a professional nutritionist and food analyst. ANALYZE THE VISUAL DETAILS CAREFULLY and provide essential nutritional information:
              ...
              content: [
                   ...
                   text: lightning_fast ? 
                     ...
                     (ultra_fast ? 
                       ...
                       (fast_mode ? 
                         "Look at visual details: orange cubes, white cream, meat texture, fermented vegetables. Provide essential nutritional analysis including vitamins and minerals." : 

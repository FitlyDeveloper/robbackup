...
app.post("/api/analyze-food", async (req, res) => {
  try {
    ...
    const response = {
      ...
      // Add micronutrients in flat format for Flutter nutrition screen
      vitamin_a: round1(totals.vitamins.A_mcg || 0),
      vitamin_c: round1(totals.vitamins.C_mg || 0),
      vitamin_d: round1(totals.vitamins.D_mcg || 0),
      vitamin_e: round1(totals.vitamins.E_mg || 0),
      vitamin_k: round1(totals.vitamins.K_mcg || 0),
      vitamin_b1: round1(totals.vitamins.B1_mg || 0),
      vitamin_b2: round1(totals.vitamins.B2_mg || 0),
      vitamin_b3: round1(totals.vitamins.B3_mg || 0),
      vitamin_b5: round1(totals.vitamins.B5_mg || 0),
      vitamin_b6: round1(totals.vitamins.B6_mg || 0),
      vitamin_b7: round1(totals.vitamins.B7_mcg || 0),
      vitamin_b9: round1(totals.vitamins.B9_mcg || 0),
      vitamin_b12: round1(totals.vitamins.B12_mcg || 0),
      calcium: round1(totals.minerals.Ca_mg || 0),
      chloride: round1(totals.minerals.Cl_mg || 0),
      chromium: round1(totals.minerals.Cr_mcg || 0),
      copper: round1(totals.minerals.Cu_mcg || 0),
      fluoride: round1(totals.minerals.F_mg || 0),
      iodine: round1(totals.minerals.I_mcg || 0),
      iron: round1(totals.minerals.Fe_mg || 0),
      magnesium: round1(totals.minerals.Mg_mg || 0),
      manganese: round1(totals.minerals.Mn_mg || 0),
      molybdenum: round1(totals.minerals.Mo_mcg || 0),
      phosphorus: round1(totals.minerals.P_mg || 0),
      potassium: round1(totals.minerals.K_mg || 0),
      selenium: round1(totals.minerals.Se_mcg || 0),
      sodium: round1(totals.minerals.Na_mg || 0),
      zinc: round1(totals.minerals.Zn_mg || 0),
      fiber: round1(totals.other.fiber_g || 0),
      cholesterol: round1(totals.other.cholesterol_mg || 0),
      sugar: round1(totals.other.sugar_g || 0),
      saturated_fats: round1(totals.other.satfat_g || 0),
      omega_3: round1(totals.other.omega3_mg || 0),
      omega_6: round1(totals.other.omega6_g || 0),
      source: { 
        nutrition: "USDA FDC", 
